...
export const AnimatedCard: FC<Props> = ({
  id,
  currentRating,
  englishWord,
  spanishTranslation,
            ...
            {currentCardIndex === Math.floor(activeIndex.value) && (
              <Animated.View
                style={[
                  ...
                  {borderColor: colors.info, top: cardHeight * 0.4},
                ]}>
                <CustomText
                  color={colors.info}
                  size={50}
            ...
            {currentCardIndex === Math.floor(activeIndex.value) && (
              <Animated.View
                style={[
                  styles.containerRatingMessage,
                  animatedRatingEasy,
                  {borderColor: colors.success, top: cardHeight * 0.4},
                ]}>
                <CustomText
            ...
            {currentCardIndex === Math.floor(activeIndex.value) && (
              <Animated.View
                style={[
                  styles.containerRatingMessage,
                  animatedRatingHard,
                  {borderColor: colors.danger, top: cardHeight * 0.4},
                ]}>
                <CustomText
                  color={colors.danger}
                  size={50}
